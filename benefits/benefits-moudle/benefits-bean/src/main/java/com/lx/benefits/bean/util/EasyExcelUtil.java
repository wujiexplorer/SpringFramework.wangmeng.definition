...
public class EasyExcelUtil {
    ...
    public static void main(String[] args) {
        String path = "http://res.zhengminyi.com/points_allocate_recycle.xls";
        List<Object> data = null;
        try {
            UrlResource resource = new UrlResource(path);
//            List<Object> list = EasyExcelUtil.readExcelWithModel(resource.getInputStream(), PointsAllocateExcelDto.class, ExcelTypeEnum.XLS);
