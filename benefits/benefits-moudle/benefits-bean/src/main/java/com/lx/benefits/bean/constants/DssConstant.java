...
public final class DssConstant {
	...
	public enum VO_WITHDRAW_STATUS{
		CAN_WITHDRAW(0, "可提现"),
		WITHDRAWING(1, "提现中"),
		UNABLE_WITHDRAW(2, "不可提现");
		private int code;
		private String desc;
		VO_WITHDRAW_STATUS(int code, String desc){
			this.code = code;
			this.desc = desc;
		}
	...
	public enum COLLECT_STATUS{
		NO(Constant.TF.NO,"未汇总"),
		YES(Constant.TF.YES,"已汇总");
		public Integer code;
		public String cnName;
	...
	public enum INDIRECT_TYPE{
		NO(Constant.TF.NO,"直接提佣"),
		YES(Constant.TF.YES,"下级提佣"),
		GRANDSON(2,"下下级提佣");
		public Integer code;
		public String cnName;
