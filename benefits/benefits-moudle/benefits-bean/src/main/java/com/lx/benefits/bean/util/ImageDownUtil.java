...
public final class ImageDownUtil {
	...
	public static String getThumbnail(final String domainPath,final String imageName,final Constant.IMAGE_SIZE showModel){
		return domainPath+imageName+"?imageView2/"+ IMAGE_SHOW_TYPE.type1.code+"/w/"+showModel.width+"/h/"+showModel.height;
	}
	
	public static String getThumbnail(final String domainPath, final String imageName, final Constant.IMAGE_SIZE showModel, final Integer type){
