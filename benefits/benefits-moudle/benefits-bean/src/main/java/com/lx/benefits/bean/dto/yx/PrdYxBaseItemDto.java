...
public class PrdYxBaseItemDto {
    ...
    private List<PrdYxBaseItemSku> skuList;
    ...
    public List<PrdYxBaseItemSku> getSkuList() {
        return skuList;
    }

    public void setSkuList(List<PrdYxBaseItemSku> skuList) {
