...
public enum MResultInfo {
	...
	ENT_USER_NOT_ACTIVATE("-106", "企业员工需确认地址信息"),
	SCAN_CODE_USER_NOT_ACTIVATE("-107", "兑换券已经发放,激活后即可使用"),
	...
	EXCHANGE_POINT_SUCCESS("0","您的优惠券已经兑换成福利币，\n请到“福利币”查看"),
	CONFIRE_SUCCESS("0","确认成功"),
	SUBMIT_SUCCESS("0","提交成功"),
	SHARE_SUCCESS("0","分享成功"),
	IMAGE_UPLOAD_SUCCESS("0","上传文件成功"),
	GIFT_SEND_SUCCESS("0","您赠送的礼物已成功发放到对方的账户中！"),
	EXCHANGE_GIFT_SUCCESS("0","您的礼物已经兑换成福利币，\n请到“福利币”查看"),
	//------------------------------新增 修改 删除 失败统一提示信息-----------------------
	...
	USERAGREEMENT_NOT_AGREED("-31017","没有同意福粒商城用户协议"),
	...
	USER_TEL_NULL("-34018","电话号码不能为空"),
	COUPON_MONEY_NULL("-34021","优惠券面值不能为空"),
	ADDRESS_STREET_NULL("-34022","乡镇街道不能为空"),
	EMPLOYEE_REGISTER_AUDITING("-34023", "您的账号已在审核中，请耐心等候。"),
	USER_NOT_EMPLOYEE("-34024","用户非企业员工"),
	GIFT_CODE_NULL("-34025","礼物编号不能为空"),
	GIFT_TYPE_NULL("-34026","礼物记录类型不能为空"),
	//------订单参数信息-35000------
	...
	IS_DUE("-35111","会员已过期，请充值！"),
	NEED_BUY_MEMBERSHIP("-35112","普通用户无法浏览，请先成为会员。"),
	//-------------推广员信息-36000------------
    ...
    WELFARE_SEARCH_ID_NOT_BLANK("6001","福利卡ID不能为空"),
    WELFARE_SEND_ID_NOT_BLANK("6002","福利发送ID不能为空"),
    USER_FEED_BACK_NULL("-34016","反馈内容不能为空"),
    USER_UN_EXISTS("-34016","用户不存在！"),
	;
